...
export default function TeacherHeader({ teacherName, leftSlot, children }: TeacherHeaderProps) {
  return (
    <header className="app-header relative z-40 flex items-center justify-between gap-3 px-4 py-3 md:flex-wrap md:gap-4 md:px-6 md:py-4">
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <h2 className="truncate text-base font-display font-semibold md:text-lg">
            Docente{teacherName ? ` ${teacherName}` : ""}
          </h2>
        </div>
      </div>
