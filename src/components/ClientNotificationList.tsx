...
type ClientNotificationListProps = {
...
const ICONS = {
  ...
  MATERIAL_REGISTRO_UPLOADED: FileCheck,
...
function getActionLabel(item: NotificationItem) {
  if (item.ticketId) {
    return "Vai al ticket ->";
  }
  ...
  if (
    ...
    return "Vai agli attestati ->";
  }
  return null;
}

export default function ClientNotificationList({
  items,
  onItemClick,
  emptyText,
