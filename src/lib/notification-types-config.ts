...
export const NOTIFICATION_TYPES: NotificationTypeConfig[] = [
  ...
  { type: "EDITION_CANCELLED", label: "Edizione annullata", description: "Quando un'edizione viene annullata (eliminata)", category: "corsi", roles: ["CLIENT"], hasInApp: true, hasEmail: true, locked: false, defaultInApp: true, defaultEmail: true },
  { type: "COURSE_COMPLETED", label: "Edizione completata", description: "Quando un'edizione viene completata (chiusa)", category: "corsi", roles: ["CLIENT"], hasInApp: true, hasEmail: true, locked: false, defaultInApp: true, defaultEmail: true },
