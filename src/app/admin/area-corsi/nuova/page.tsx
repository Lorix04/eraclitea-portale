...
export default function NuovaAreaPage() {
  ...
  const handleSubmit = async () => {
    ...
    setSaving(false);
    if (!res.ok) return;
    router.push("/admin/area-corsi");
  };

  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <Link href="/admin/area-corsi" className="text-sm text-muted-foreground">
          &larr; Indietro
        </Link>
        <h1 className="text-xl font-semibold">Nuova area</h1>
      </div>
      ...
      <div className="flex justify-end gap-3">
        <Link href="/admin/area-corsi" className="rounded-md border px-4 py-2 text-sm">
          Annulla
        </Link>
        <button
          type="button"
